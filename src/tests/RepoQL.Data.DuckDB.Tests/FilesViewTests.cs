...
public class FilesViewTests
{
    ...
    [Test]
    [DisplayName("Source extraction works for help:// URIs")]
    public void FilesView_SourceExtraction_HelpScheme()
    {
        using var db = TestServiceCollectionExtensions.CreateTestDataStore();

        var uri = RepoUri.Parse("help:///quickstart.md")!;
        db.IndexArtifact(uri, CreateTestArtifact(uri));
    ...
    public void FilesView_MultipleFiles()
    {
        ...
        db.IndexArtifact(RepoUri.Parse("help:///readme.md")!, CreateTestArtifact(RepoUri.Parse("help:///readme.md")!));
