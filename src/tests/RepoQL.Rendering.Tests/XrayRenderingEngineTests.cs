...
public class XrayRenderingEngineTests
{
    private readonly XrayRenderingEngine _engine = new();
    ...
    public void Given_EmptyResults_Then_ReturnsEmpty()
    {
        ...
        var output = _engine.Render(Array.Empty<XrayResult>(), context);
    ...
    public void Given_ExploreIntent_Then_ShowsCompact()
    {
        var results = new[]
        {
            new XrayResult("file:///src/Auth.cs", 85, null, "Auth service", null, null, null),
            new XrayResult("file:///src/User.cs", 80, null, "User service", null, null, null),
        };
        var context = new RenderingContext(Intent.Explore, TokenBudget: 1000, Limit: null, HasSearchCriteria: true);
    ...
    public void Given_NoSearchCriteria_Then_OmitsConfidence()
    {
        ...
        var context = new RenderingContext(Intent.Explore, TokenBudget: 1000, Limit: null, HasSearchCriteria: false);
    ...
    public void Given_FindWithStandouts_Then_RichForTopTier()
    {
        var results = new[]
        {
            new XrayResult("file:///src/Auth.cs#line=42", 95, "method", "ValidateToken", null, "public bool Validate() { return true; }", "csharp"),
            new XrayResult("file:///src/User.cs", 40, null, "User service", null, null, null),
        };
    ...
    public void Given_SmallBudget_Then_TruncatesResults()
    {
        var results = Enumerable.Range(0, 20)
            .Select(i => new XrayResult($"file:///src/File{i}.cs", 60 + i, null, $"File {i}", null, null, null))
            .ToArray();
        var context = new RenderingContext(Intent.Explore, TokenBudget: 200, Limit: null, HasSearchCriteria: true);
    ...
    public void Given_ExplicitLimit_Then_UsesLimit()
    {
        var results = Enumerable.Range(0, 10)
            .Select(i => new XrayResult($"file:///src/File{i}.cs", 60, null, $"File {i}", null, null, null))
            .ToArray();
        var context = new RenderingContext(Intent.Explore, TokenBudget: 5000, Limit: 3, HasSearchCriteria: true);
    ...
    public void Given_ObjectResults_Then_ShowsKindBadges()
    {
        var results = new[]
        {
            new XrayResult("file:///src/Auth.cs#line=42", 90, "method", "ValidateToken", null, null, null),
            new XrayResult("file:///src/User.cs#line=10", 85, "class", "UserService", null, null, null),
        };
        var context = new RenderingContext(Intent.Find, TokenBudget: 1000, Limit: null, HasSearchCriteria: true);
    ...
    public void Given_MultilineItems_Then_BlankLinesBetween()
    {
        var results = new[]
        {
            new XrayResult("file:///a.cs", 95, null, "Headline A", "- Structure A", null, null),
            new XrayResult("file:///b.cs", 90, null, "Headline B", "- Structure B", null, null),
        };
