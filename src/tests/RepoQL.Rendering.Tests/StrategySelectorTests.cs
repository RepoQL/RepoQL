...
public class StrategySelectorTests
{
    ...
    {
        var strategy = StrategySelector.Select(Intent.Inventory, DistributionShape.Lumpy, pressure: 0.5);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Inventory, DistributionShape.Lumpy, pressure: 0.8);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Inventory, DistributionShape.Even, pressure: 0.3);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Inventory, DistributionShape.Even, pressure: 0.9);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Locate, DistributionShape.Lumpy, pressure: 0.4);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Locate, DistributionShape.Lumpy, pressure: 0.85);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Locate, DistributionShape.Even, pressure: 0.5);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Locate, DistributionShape.Even, pressure: 0.75);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Inspect, DistributionShape.Lumpy, pressure: 0.3);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Inspect, DistributionShape.Lumpy, pressure: 0.9);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Inspect, DistributionShape.Even, pressure: 0.4);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Inspect, DistributionShape.Even, pressure: 0.8);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Locate, DistributionShape.Lumpy, pressure: 0.7);
    ...
    {
        var strategy = StrategySelector.Select(Intent.Locate, DistributionShape.Lumpy, pressure: 0.69);
    ...
    public void Given_AnyNonOmittingStrategy_Then_BottomTierIsMinimal()
    {
        ...
        var exploreLumpy = StrategySelector.Select(Intent.Inventory, DistributionShape.Lumpy, pressure: 0.3);
        var exploreEven = StrategySelector.Select(Intent.Inventory, DistributionShape.Even, pressure: 0.3);
        var findEven = StrategySelector.Select(Intent.Locate, DistributionShape.Even, pressure: 0.3);
        var readEven = StrategySelector.Select(Intent.Inspect, DistributionShape.Even, pressure: 0.3);
