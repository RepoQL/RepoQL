...
public static class StrategySelector
{
    ...
    public static TierStrategy Select(Intent intent, DistributionShape shape, double pressure)
    {
        ...
        {
            Intent.Inventory => SelectExploreStrategy(shape, highPressure),
            Intent.Locate => SelectFindStrategy(shape, highPressure),
            Intent.Inspect => SelectReadStrategy(shape, highPressure),
