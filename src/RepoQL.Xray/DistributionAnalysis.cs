...
public record DistributionAnalysis(
    IReadOnlyList<XrayResult> TopTier,
    IReadOnlyList<XrayResult> MiddleTier,
    IReadOnlyList<XrayResult> BottomTier,
...
)
{
    ...
    /// </summary>
    public IEnumerable<XrayResult> AllResults => TopTier.Concat(MiddleTier).Concat(BottomTier);
