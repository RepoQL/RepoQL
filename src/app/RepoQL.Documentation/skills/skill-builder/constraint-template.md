---
description: Structural template for writing constraint-heavy skills that encode non-negotiable rules with scope and enforcement.
tags: ["skill", "skill-builder", "constraint", "template"]
audience: ["LLMs"]
