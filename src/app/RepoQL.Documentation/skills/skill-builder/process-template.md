---
description: Structural template for writing process-heavy skills that encode ordered sequences with verification and recovery.
tags: ["skill", "skill-builder", "process", "template"]
audience: ["LLMs"]
