---
description: Guidance for writing constraint-heavy skills that encode non-negotiable rules where deviation causes harm.
tags: ["skill", "skill-builder", "constraint", "authoring"]
audience: ["LLMs"]
