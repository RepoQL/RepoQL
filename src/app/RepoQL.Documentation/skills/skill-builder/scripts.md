---
description: Guidance for using executable scripts in skills to fetch live data, automate steps, and verify compliance.
tags: ["skill", "skill-builder", "scripts", "automation"]
audience: ["LLMs"]
