---
description: Reference for Mermaid state diagrams covering lifecycle management, transitions, composite states, and styling.
tags: [skill, mermaid-diagrams, state-diagram]
audience: [LLMs]
