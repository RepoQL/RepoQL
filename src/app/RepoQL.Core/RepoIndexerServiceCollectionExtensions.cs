...
using RepoQL.Formats.Python;
using RepoQL.Formats.Go;
using RepoQL.Formats.Rust;
...
public static class RepoIndexerServiceCollectionExtensions
{
        ...
        string? repoRootPath = null)
    {
        ...
        services.AddPythonFormat();
        services.AddRubyFormat();
        services.AddGoFormat();
        services.AddRustFormat();
        ...
        services.AddSingleton<RepoQL.Contracts.Data.IGraphReader>(sp => sp.GetRequiredService<DuckDbDataStore>());
