---
description: Structural template for writing knowledge-heavy skills using capsules, structured entries, and schema definitions.
tags: ["skill", "skill-builder", "knowledge", "template"]
audience: ["LLMs"]
