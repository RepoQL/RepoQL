---
description: "Guides intentional skill design. Use when creating, improving, or reviewing Claude Code skills. Requires a zone assessment before writing."
tags: ["skill", "skill-builder", "authoring", "design", "zones"]
audience: ["LLMs"]
...
- SeeAlso: `help:///skills/skill-builder/knowledge.md`
...
- SeeAlso: `help:///skills/skill-builder/process.md`
...
- SeeAlso: `help:///skills/skill-builder/constraint.md`
...
- SeeAlso: `help:///skills/skill-builder/wisdom.md`
...
|--------------|-------------------|
| Knowledge | `help:///skills/skill-builder/knowledge.md` |
| Process | `help:///skills/skill-builder/process.md` |
| Constraint | `help:///skills/skill-builder/constraint.md` |
| Wisdom | `help:///skills/skill-builder/wisdom.md` |
...
- **`help:///skills/skill-builder/knowledge.md`** — Structuring facts for retrieval, when high agency fits
- **`help:///skills/skill-builder/process.md`** — When sequences matter, balancing flexibility with structure
- **`help:///skills/skill-builder/constraint.md`** — Rules without justification, when prescription is appropriate
- **`help:///skills/skill-builder/wisdom.md`** — Introducing ideas that change thinking, not templates

Skills with balanced distributions: consult multiple references, weight by allocation.

### Templates

- **`help:///skills/skill-builder/knowledge-template.md`** — Template for knowledge-heavy skills
- **`help:///skills/skill-builder/process-template.md`** — Template for process-heavy skills
- **`help:///skills/skill-builder/constraint-template.md`** — Template for constraint-heavy skills
- **`help:///skills/skill-builder/wisdom-template.md`** — Template for wisdom-heavy skills

### Exemplars

- **`help:///skills/skill-builder/exemplar-constraint-skill.md`** — Worked example of a constraint skill
- **`help:///skills/skill-builder/exemplar-wisdom-skill.md`** — Worked example of a wisdom skill

### Cross-Cutting

- **`help:///skills/skill-builder/scripts.md`** — When to use scripts, best practices, platform considerations
...
**Example**
The zone capsules above tell you what each zone IS, not how to write one well. You cannot write a good wisdom skill from this page alone—you must read `help:///skills/skill-builder/wisdom.md`.
