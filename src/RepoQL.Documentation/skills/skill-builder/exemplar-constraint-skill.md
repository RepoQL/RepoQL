---
description: Exemplar showing how to write a constraint-heavy skill through a worked example of secret handling rules.
tags: ["skill", "skill-builder", "constraint", "exemplar"]
audience: ["LLMs"]
