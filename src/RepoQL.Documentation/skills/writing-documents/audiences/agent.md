---
description: Detailed reference for writing patterns optimized for agent readers.
tags: [skill, writing-documents, audiences, agent]
audience: [LLMs]
...
## Capsule: PrimacyEffect

**Invariant**
Information presented first frames interpretation of everything after.

**Example**
Constraint stated in opening colors every subsequent fact. Same constraint buried in middle may be processed but not integrated into the interpretive frame.
//BOUNDARY: Primacy is about framing, not importance. Critical facts can appear later if framing is established.

**Depth**
- Early content establishes the lens through which all subsequent content is processed
- Scope boundaries, key constraints, document purpose belong at the start
- A misframed opening causes compounding misinterpretation
- Use for: what this is, what problem it solves, what constraints apply

## Capsule: RecencyEffect

**Invariant**
Information presented last is most accessible during output generation.

**Example**
Checklist at document end reinforces practices right before agent acts. Key points in final section surface in generated responses.
//BOUNDARY: Recency is for reinforcement, not for hiding. Don't bury critical framing at the end.

**Depth**
- Final content has privileged access when generating output
- Checklists leverage recency for actions (things to do)
- Bullet points leverage recency for emphasis (things to remember)
- Keep both short—recency amplifies, verbosity dilutes
- Corrections or caveats to earlier content land effectively here

## Capsule: ClosingLines

**Invariant**
Closing lines shape agent understanding; actionable tests beat pithy aphorisms.

**Example**
Good: "*If you can't compress it to one line, you may not understand it yet.*" — testable.
Bad: "*The essence of wisdom is knowing what to leave out.*" — singsong nonsense.
//BOUNDARY: If it sounds like a fortune cookie, cut it.

**Depth**
- "If X, then Y" format gives agents a test to apply
- Pithy summaries get echoed verbatim into output without adding value
- Closers genuinely help agent comprehension via recency effect
- Worth including when they calibrate understanding, not when they decorate
...
**Beginning (Frame)**
Leverage PrimacyEffect. What is this, what problem it solves, key constraints, scope boundaries.

**Middle (Retrieval)**
Structured for finding specific facts later. Consistent patterns: tables, capsules, entries. Headers that work as search keys.
