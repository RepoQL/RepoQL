---
description: Reference for Mermaid architecture diagrams covering service topology, groups, and directional edges.
tags: [skill, mermaid-diagrams, architecture-diagram]
audience: [LLMs]
