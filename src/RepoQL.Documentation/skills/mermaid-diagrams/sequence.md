---
description: Reference for Mermaid sequence diagrams covering multi-party interactions, activation boxes, and protocol flows.
tags: [skill, mermaid-diagrams, sequence-diagram]
audience: [LLMs]
