---
description: Cross-cutting Mermaid syntax rules for quoting, escaping, comments, layout engines, styling, and accessibility.
tags: [skill, mermaid-diagrams, syntax]
audience: [LLMs]
