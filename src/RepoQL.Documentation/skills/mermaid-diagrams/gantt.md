---
description: Reference for Mermaid Gantt charts covering project schedules, task dependencies, milestones, and critical paths.
tags: [skill, mermaid-diagrams, gantt]
audience: [LLMs]
